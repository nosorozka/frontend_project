...
export default {
  ...
  methods: {
    makeAlert() {
      if (this.name && this.surname && this.email && this.subject) {
              ...
              <div class="col-lg-12">
                <form id="contact-form">
                  <div class="row">
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="name" v-model="name" name="name" id="name" placeholder="Your Name..."
                          autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="surname" v-model="surname" name="surname" id="surname"
                          placeholder="Your Surname..." autocomplete="on" required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="text" v-model="email" name="email" id="email" pattern="[^ @]*@[^ @]*"
                          placeholder="Your E-mail..." required>
                      </fieldset>
                    </div>
                    <div class="col-lg-6">
                      <fieldset>
                        <input type="subject" v-model="subject" name="subject" id="subject" placeholder="Subject..."
                          autocomplete="on">
                      </fieldset>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                      <fieldset>
                        <button @click.prevent="makeAlert" type="submit" id="form-submit"
                          class="orange-button">Subscribe</button>
                      </fieldset>
                    </div>
                  </div>
                </form>
